...
WINDOWS=[('2023-01-01','2023-03-31'),('2024-01-01','2024-03-31'),('2025-01-01','2025-03-31'),('2026-01-01','2026-03-31'),('2026-04-01','2026-06-30')]
def main():
    old=(src.START,src.END);out={'version':'VMEWS-FLOW-WINDOW-PROBE-12.1.0','generatedAt':datetime.now(timezone.utc).isoformat(),'symbol':'FPT','dateContract':'CafeF GDKhoiNgoai StartDate/EndDate use ISO YYYY-MM-DD','windows':[]};allrows=[]
    try:
        for a,b in WINDOWS:
            src.START=a;src.END=b
            try:r=src.json_rows('FPT','foreign');route='JSON_ISO'
            except BaseException as e:r=[];route=f'JSON_ERROR:{type(e).__name__}'
