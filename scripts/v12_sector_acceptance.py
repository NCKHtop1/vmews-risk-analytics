...
checks={
 ...
 'historicalEventSectorAbstain':sec.get('historicalEventSectorGroupingEnabled') is False and sec.get('historicalNumericalTaxonomyMode')=='ABSTAIN_NO_ASOF_ARCHIVE',
 'currentReferenceCoverageAudited':float(sec.get('currentReferenceCoverage') or 0)>=.75,
 'currentReferenceSourceAudited':bool(sec.get('currentReferenceSourceAudit')),
