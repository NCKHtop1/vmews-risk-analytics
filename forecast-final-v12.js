...
function pupText(q,d=0){return validatedDirection(q)?pct(q.probUp,d):q?.pointDirectionValidated===true&&finite(q.historicalDirectionAccuracy)?`Dấu đúng ${pct(q.historicalDirectionAccuracy,0)}`:"Chưa validate"}
