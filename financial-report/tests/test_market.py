...
class MarketTests(unittest.TestCase):
    ...
    def test_rss_requires_real_publisher_link_and_publication_date(self):
        ...
        xml='<rss><channel>'+item('https://vnexpress.net/a.html?utm_source=x')+item('javascript:alert(1)')+item('https://vnexpress.net.evil.test/a')+item('https://vnexpress.net/old','bad date')+'</channel></rss>'
