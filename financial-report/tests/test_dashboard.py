...
const mbb=JSON.parse(fs.readFileSync(process.argv[3])).quarterly;
...
console.log(JSON.stringify({vic:m,bank:dash.model(mbb,['2026-Q2']),incomplete:dash.model(incomplete,['2026-Q2']),geometry:dash.geometry([{period:'2025-Q3',value:-100},{period:'2025-Q4',value:null},{period:'2026-Q2',value:0}]),empty:dash.model(null,[])}));
"""
